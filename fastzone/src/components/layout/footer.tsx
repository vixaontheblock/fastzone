      ...
      <div className="container-custom">
        ...
        <div className="flex flex-col gap-10 md:flex-row md:justify-between">
          ...
          <div className="flex flex-col gap-2">
            <p className="text-xs uppercase tracking-widest text-white/30 mb-1">Servicios</p>
          ...
          {/* Contact */}
          <div className="flex flex-col gap-2">
            <p className="text-xs uppercase tracking-widest text-white/30 mb-1">Contacto</p>
            <Link
        ...
        <div className="mt-12 border-t border-white/10 pt-6 flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
          ...
          <Link
            ...
            target="_blank"
            className="text-xs text-white/20 hover:text-white/60 transition"
          >
