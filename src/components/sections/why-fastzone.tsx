...
const items = [
  { icon: Shield, title: "Compra segura", desc: "Procesos transparentes y verificados." },
  { icon: Clock, title: "Respuesta rápida", desc: "Atendemos en minutos por WhatsApp." },
  { icon: BadgeCheck, title: "Vehículos revisados", desc: "Autos inspeccionados antes de venta." },
  { icon: Globe2, title: "Importación directa", desc: "Traemos autos desde USA sin intermediarios." },
];
